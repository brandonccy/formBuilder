...
<div class="form-group">
	...
	<input type="number" class="form-control" id="<?=$COLUMN_NAME?>" name="<?=$COLUMN_NAME?>" <?php if($row["required"]==0){ ?> required="required"<?php } ?> style="<?=$row["column_css"]?>" placeholder="<?=$row["placeholder"]?>">
